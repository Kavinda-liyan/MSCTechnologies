...
$query = "SELECT * FROM addpproducts WHERE category='NETWORKING' LIMIT $offset, $recordsPerPage";
$book = mysqli_query($mysqli, $query);

// Count the total number of records
$totalRecordsQuery = "SELECT COUNT(*) AS total FROM addpproducts WHERE category='NETWORKING'";
        ...
        <div class="Product-Sort">
            <div class="row">
                <div class="col-md-6 pull-left">
                    <h1 class="text-light px-2" style="font-weight: bold;">Networking</h1>
                </div>
            ...
            <ul class="pagination">
                <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                    <li class="page-item <?php if ($i === $page) echo 'active'; ?>">
                        <a class="page-link" href="network.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                <?php endfor; ?>
            </ul>
        </nav>
