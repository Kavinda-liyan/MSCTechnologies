                ...
                <div class="card mb-1 " style="background-color: rgba(255, 255, 255, 0.125);">
                  ...
                  <ul class="list-group m-1 categories" style="background-color: rgba(255, 255, 255, 0.125); font-weight: bold;">
                    <a href="viewuser.php" class="nav-link linkhover">
                      <li class="list-group-item list-group-item" style="background-color:aqua;"><i class="fa fa-users"></i><span class="p-2  ">View Users</span></li>
                    </a>
                 ...
                 <?php
                          ...
                          {  
                               ...
                               <tr class="TableDetail">
                                    ...
                                    <td>'.$row["address2"].'</td>  
                                    <td>'.$row["regdate"].'</td>  
                                    <td><center><a href="deluser.php?del='.$row["id"].'" class="btn btn-warning">Delete</a></center></td>
